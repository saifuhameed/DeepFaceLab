if __name__ == "__main__":
    ...
    def process_merge(arguments):
        ...
        Merger.main ( model_class_name       = arguments.model_name,
                      ...
                      start_image            = arguments.start_image,
                      end_image              = arguments.end_image,
                      cpu_only               = arguments.cpu_only)
    ...
    p.add_argument('--force-gpu-idxs', dest="force_gpu_idxs", default=None, help="Force to choose GPU indexes separated by comma.")
    p.add_argument('--start-image', dest="start_image", default=None, help="Start merge from specified image")
    p.add_argument('--end-image', dest="end_image", default=None, help="End merge till specified image")
